...
---
Source file confirming the current flat view union: `/home/user/project/claude-history-dashboard/src/types.ts:179`. The per-session metric-tile duplication between `sessions` and `automation` both originate at `/home/user/project/claude-history-dashboard/src/components/SessionList.tsx:305-363`.
