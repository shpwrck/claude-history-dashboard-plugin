...
// and the persisted dataset cache survives restarts where that env changed.
...
// v26 (#2707): DocNode gains gitMtimeProvenance (git | manifest | filesystem |
// unavailable) and gitMtimeIso may now come from the packaged git-times
