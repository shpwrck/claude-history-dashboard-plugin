...
export type View = 'home' | 'evaluator' | 'recommendations' | 'sessions' | 'projects' | 'search' | 'stats' | 'tokens' | 'tools' | 'files' | 'summary' | 'cost' | 'reclaim-compass' | 'timeline' | 'forensics' | 'activity' | 'automation' | 'workflows' | 'errors' | 'permissions' | 'agents' | 'memories' | 'context' | 'conversation' | 'prompts' | 'patterns' | 'shadow-calls' | 'model-evals' | 'report-card' | 'review-queue' | 'tasks' | 'teams' | 'plans' | 'pulse' | 'diary' | 'adoption' | 'provisioning' | 'enterprise';
